...
// Simplesmente nos mostra os dados e é a saída
procedure showMedian(TMemo: TMemo; number: double; numbers: TNumeros);
var
  text: string;
begin
  ...
  TMemo.Lines.Clear;
  TMemo.Lines.Add('A média dos números: ' + text + ' é ' + FormatFloat('0.##', number))
end;

// Retorna um texto que contém todos os números usados para calcular a média
function parseArray(numbers: TNumeros): String;
var
  text: string;
//  J: double;
